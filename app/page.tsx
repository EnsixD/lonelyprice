...
export default async function Page() {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden">
      ...
      {/* Рекламный баннер - фиксированный внизу */}
      <AdBanner />

      {/* Основной контент */}
      <div className="flex-1">
        {/* Навигация */}
        <div className="border-b border-border bg-card/30 backdrop-blur-xl sticky top-0 z-50">
        ...
        {/* Hero Section */}
        <div className="relative overflow-hidden bg-gradient-to-br from-background/50 via-background/50 to-primary/5 border-b border-border">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-24 lg:py-32 lg:px-8">
            <div className="flex flex-col items-center text-center">
              <Badge className="mb-4 bg-primary/10 text-primary border-primary/20 hover-scale">
                <Zap className="w-3 h-3 mr-1" />
                Профессиональные услуги
              </Badge>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight bg-gradient-to-r from-foreground via-primary to-foreground/60 bg-clip-text text-transparent text-balance">
                Lonely PRICE
              </h1>
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto px-4 sm:px-0">
                <Button
                  asChild
                  size="lg"
                  className="font-semibold hover-scale w-full sm:w-auto"
                >
                  <Link href="/services">
                    <ShoppingCart className="w-4 h-4 mr-2" />
                    Все услуги
                ...
                {!user && (
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="hover-scale bg-transparent w-full sm:w-auto"
                  >
              ...
              <div className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-3xl w-full px-4">
                <div className="flex flex-col items-center hover-scale">
                  <div className="rounded-full bg-primary/10 p-3 mb-3 hover:bg-primary/20">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="mb-8 sm:mb-12 text-center px-4">
            ...
            <p className="mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg text-muted-foreground text-balance">
              Широкий спектр профессиональных услуг для продвижения в стриминге
              и медиа
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 px-4">
            <div className="p-5 sm:p-6 rounded-lg border border-border bg-card/50 backdrop-blur-sm hover-scale card-glow">
        ...
        <div className="bg-gradient-to-b from-background to-primary/5 border-y border-border backdrop-blur-sm">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            <TelegramChannels />
          </div>
        </div>
        ...
        {/* CTA Section */}
        <div className="bg-primary/5 border-y border-border backdrop-blur-sm">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 text-center">
            ...
            <p className="mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg text-muted-foreground text-balance px-4">
              Зарегистрируйтесь сейчас и получите доступ ко всем
              профессиональным услугам
            </p>
            {!user && (
              <Button asChild size="lg" className="mt-6 sm:mt-8 hover-scale">
